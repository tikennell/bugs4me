...
define("WORDING_BACK_TO_LOGIN", "Login Page");
...
define("WORDING_REGISTER", "Sign Up");
define("WORDING_REGISTER_NEW_ACCOUNT", "Register now");
...
define("WORDING_REGISTRATION_EMAIL", "User's email (A verification email with an activation link will be sent to you)");
